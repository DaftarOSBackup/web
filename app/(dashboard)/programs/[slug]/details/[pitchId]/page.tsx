...
import { Mail, Phone, Download, Eye, Trash2, Search, Filter, Calendar, MapPin, Users, FileText, Check, X, Link } from "lucide-react"
        ...
        {activeSection === "documentation" && (
          <div className="flex gap-6">
            ...
            <div className="w-[200px] space-y-1">
              ...
              {["private", "received", "sent"].map((type) => (
                <Button
                  key={type}
                  variant="ghost"
                  className={cn(
                    "w-full justify-start text-sm font-normal",
                    selectedDocType === type && "bg-muted font-medium"
                  )}
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="space-y-0.5">
                      <p className="text-xs text-muted-foreground">
                        Uploaded by <span className="text-blue-600">{doc.uploadedBy}</span>
                      </p>
                      <p className="text-xs text-muted-foreground">{doc.daftarName}</p>
                      <p className="text-xs text-muted-foreground">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm">{pitchDetails.sections.report.summary}</p>
              </div>
              <div>
                <h3 className="font-medium mb-2">Recommendations</h3>
                <p className="text-sm">{pitchDetails.sections.report.recommendations}</p>
              </div>
            </div>
          </div>
        )}
